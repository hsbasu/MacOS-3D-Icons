...
THEMEDIR=../usr/share/icons/Sucharu
    ...
    do
        ...
        do
            ...
            if [ -f $THEMEDIR/$CONTEXT/$SIZE/$ICON_NAME.png ]; then
                echo $THEMEDIR/$CONTEXT/$SIZE/$ICON_NAME.png exists. Removing ...
                rm -f $THEMEDIR/$CONTEXT/$SIZE/$ICON_NAME.png
            ...
            if [ -f $THEMEDIR/$CONTEXT/$SIZE@2x/$ICON_NAME.png ]; then
                echo $THEMEDIR/$CONTEXT/$SIZE@2x/$ICON_NAME.png exists. Removing ...
                rm -f $THEMEDIR/$CONTEXT/$SIZE@2x/$ICON_NAME.png
